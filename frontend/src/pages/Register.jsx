    ...
    <div style={{ background: '#03050f', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Sans', sans-serif", position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: 420, padding: '0 1.5rem' }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '2.5rem', backdropFilter: 'blur(20px)' }}>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: '1.75rem', fontWeight: 800, letterSpacing: '-0.5px', marginBottom: '0.5rem' }}>Create account</h2>
          <p style={{ color: 'rgba(232,234,240,0.45)', fontSize: '0.9rem', marginBottom: '2rem' }}>Join NexVault and start banking smarter</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              <label style={{ display: 'block', fontSize: '0.8rem', color: 'rgba(232,234,240,0.6)', marginBottom: '0.5rem', letterSpacing: '0.03em' }}>Full Name</label>
              <input
                type="text"
                name="name"
                value={form.name}
                onChange={handleChange}
                placeholder="Arka Patra"
                required
            ...
            {/* Password hint */}
            <p style={{ fontSize: '0.78rem', color: 'rgba(232,234,240,0.3)', marginBottom: '1.75rem' }}>
          ...
          {/* Terms */}
          <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.75rem', color: 'rgba(232,234,240,0.25)', lineHeight: 1.6 }}>
            By creating an account you agree to our Terms of Service and Privacy Policy.
          </p>

          <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: '0.875rem', color: 'rgba(232,234,240,0.45)' }}>
            Already have an account?{' '}
            <Link to="/login" style={{ color: '#00f5c4', textDecoration: 'none', fontWeight: 500 }}>
              Log in
            </Link>
          </p>
        </div>
